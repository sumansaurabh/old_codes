...
function init() {
	...
	// 	yoyo:true
	// });
	TweenLite.fromTo(textAnimation, 4,
		{animationProgress:1.0},
		{animationProgress:0.0},
		0
	);

	// console.log(textAnimation['ease']);
	// textAnimation.animationProgress = 1.0;
	// setTimeout(function() {
	// 	textAnimation.animationProgress = 0.0;
	// }, 4000);
...
function createTextAnimation() {
	var geometry = generateTextGeometry('Suman Saurabh', {
		size:150,
		height:0,
		font:'droid sans',
		weight:'bold',
...
THREERoot.prototype = {
	...
	resize: function() {
		...
		this.camera.aspect = 1000/100;
		this.camera.updateProjectionMatrix();
		console.log("setting width ==> ",window.innerWidth );

		this.renderer.setSize(1000, 100);
	}
};
